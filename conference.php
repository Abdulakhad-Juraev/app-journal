...
?>
    <div class="container-fluid mx-auto flex items-center justify-center"
        ...
        <h1 class="montserrat text-white text-7xl font-medium">Konferensiyalar</h1>
    </div>
        ...
        <div class="container pt-5 mx-auto">
            <div class="mx-20">
                <div class="mt-16">
                    <?
                    $con;
                    $sql = "select * from conference order by id desc limit 0,5";
                                ...
                                <div class="flex">
                                    ...
                                    <div>
                                        ...
                                        <div class="font-semibold flex mt-20">
                                            <a href="conference-detail.php?cid=<?= $q['id']; ?>" class="text-sm text-blue-800 underline mr-4">Konferensiyani ko'rish</a>
