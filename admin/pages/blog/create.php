...
<div class="container">
    <form method="post" enctype="multipart/form-data">
        ...
        <div class="row mt-4">
            ...
            <div class="col-12 mt-3"><span><?=$local_strings[$lang]['code']; ?></span><input type="text" name="code" class="form-control">
            </div>
        ...
        if (isset($_POST['submit'])) {
            ...
            if ($sizeFile >=10240){
                ...
                $sqlblog = "insert into blog(name_uz,name_ru,name_en,content_uz,content_ru,content_en,photo,soni,kuni,yonalish_uz,yonalish_ru,yonalish_en,code,vaqt) values ('{$nameuz}','{$nameru}','{$nameen}','{$contentuz}','{$contentru}','{$contenten}','{$data}','{$son}','{$kun}','{$yonalishuz}','{$yonalishru}','{$yonalishen}','{$code}',NOW())";
