    ...
    if ($district !== null) {
        ...
        <div class="row mt-5">
            ...
            if ($lang_count >= 3){
                ...
                echo "<div class='col-4 mt-5'>";
                echo "<span>".$local_strings[$lang]['pattern']." Uz</span>";
                echo "<textarea class='form-control' rows='2' disabled>".$district['yonalish_uz']."</textarea>";
                echo "</div>";

                echo "<div class='col-4 mt-5'>";
                echo "<span>".$local_strings[$lang]['pattern']." Ru</span>";
                echo "<textarea class='form-control' rows='2' disabled>".$district['yonalish_ru']."</textarea>";
                echo "</div>";

                echo "<div class='col-4 mt-5'>";
                echo "<span>".$local_strings[$lang]['pattern']." En</span>";
                echo "<textarea class='form-control' rows='2' disabled>".$district['yonalish_en']."</textarea>";
                echo "</div>";

                echo "<div class='col-4 mt-5'>";
                echo "<span>".$local_strings[$lang]['daycount']."</span>";
                echo "<input class='form-control' disabled value='".$district['soni']."'>";
                echo "</div>";

                echo "<div class='col-4 mt-5'>";
                echo "<span>".$local_strings[$lang]['p4']."</span>";
                echo "<input class='form-control' disabled value='".$district['kuni']."'>";
                echo "</div>";

                echo "<div class='col-4 mt-5'>";
                echo "<span>".$local_strings[$lang]['code']."</span>";
                echo "<input class='form-control' disabled value='".$district['code']."'>";
                echo "</div>";

                echo "<div class='col-12 mx-auto mt-5'>";
